    ...
    <div id="miert">
        <div class="d-flex justify-content-around align-items-center mb-3">
            ...
            <div id="msz">
                ...
                <ul>
                    <li>
                        <p> Ragyogó állapotú motorok: Minden motorkerékpárunk kiváló műszaki állapotban van, és alapos
                            karbantartáson esik át a bérbeadás előtt.</p>
                    </li>
                    <li>
                        <p>Extra felszerelések: Telefontartó, töltő és túradobozok biztosítják a kényelmes és praktikus
                            utazást.
                        </p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p>Ingyenes parkolás: Biztonságos, ingyenes parkolási lehetőséget biztosítunk éjjeli őrrel és
                            kamerával.
                        </p>
                    </li>
                    <li>
                        <p>Szakértő csapat: Tapasztalt csapatunk örömmel segít a választásban és a tervezésben.</p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p>Kilométer korlátozás nélkül: Nálunk nem kell számolgatni, izgulni hogy mennyi km fér aznap
                            még bele.
                        </p>
                    </li>
                </ul>
    ...
    <div class="timeline">
        ...
        <div class="container left">
            <div class="content " id="c3">
                ...
                <h2>2015</h2>
                <p>Lorem ipsum dolor sit amet, quo ei55555555654656 656 456 6456 456 262626255555555555555555 simul
                    congue
