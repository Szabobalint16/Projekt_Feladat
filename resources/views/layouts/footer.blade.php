                ...
                <div class="container p-4">
                    ...
                    <div class="row mt-2 justify-content-evenly">
                        ...
                        <div class="col-lg-4 col-md-6 mb-4 mb-md-0">
                            <h5 class="text-uppercase mb-4 pb-1">Linkek</h5>

                            <ul class="fa-ul link" style="margin-left: 1.65em;">
                                <li class="mb-3">
                                    <span class="fa-li"> <i class="fas fa-home"></i></span><a href=""><span
                                            class="ms-2">Kezdőlap</span></a>
                                </li>
                                <li class="mb-3">
                                    <span class="fa-li"><i class="bi bi-person-lines-fill"></i></span><a href=""><span
                        ...
                        <div class="col-lg-4 col-md-6 mb-4 mb-md-0 search">
                            ...
                            <ul class="fa-ul link" style="margin-left: 1.65em;">
                                ...
                                <li class="mb-3">
                                    <span class="fa-li"><i class="fas fa-envelope"></i></span><a
                                ...
                                <li class="mb-3">
                                    <span class="fa-li"><i class="fas fa-phone"></i></span><a href="tel:+"><span
                                            class="ms-2">+ 01 234 567 88</span></a>
                                </li>
                                <li class="mb-3">
                                    <span class="fa-li"><i class="fas fa-print"></i></span><a href="tel:+"><span
                                            class="ms-2">+ 01 234 567 88</span></a>
                                </li>
                            </ul>
                        </div>
